    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-books">Display a listing of the books.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-books">
                                <a href="#endpoints-POSTapi-books">Store a new book.</a>
                            </li>
                                ...
                                <a href="#endpoints-PUTapi-books--id-">Update a book.</a>
                            </li>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-books">Display a listing of the books.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-books">Store a new book.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The book's title. Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The author's name. Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The name of the book. Example: <code>architecto</code></p>
        </div>
        </form>
...
<p>The ID of the book. Example: <code>16</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-books--id-">Update a book.</h2>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-books--id-"
               value="architecto"
               data-component="body">
    <br>
<p>The name of the book. Example: <code>architecto</code></p>
